...
// Пример программы, которая принимает на вход список целых чисел и заданное целое число,
// фильтрует список по числам, которые делятся на заданное число без остатка.

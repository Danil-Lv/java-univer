...
// Пример программы, которая принимает на вход список целых чисел и заданное минимальное значение,
// фильтрует числа по значению, оставляя только числа, которые больше заданного значения.

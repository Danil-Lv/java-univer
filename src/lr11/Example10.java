...
// Пример программы, которая принимает на вход список целых чисел и заданное максимальное значение,
// фильтрует числа по значению, оставляя только числа, которые меньше заданного значения.
